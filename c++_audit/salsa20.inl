...
namespace ucstk
{
    ...
    {
        //static const uint8_t constants[] = { 0x61,0x70,0x78,0x65,0x31,0x2d,0x64,0x6e,0x79,0x62,0x2d,0x36,0x6b,0x2d,0x65,0x74};
        static const uint8_t constants[] = "expand 16-byte k";
        ...
        vector_[11] = convert(&key[0]);
        vector_[12] = convert(&key[4]);
        vector_[13] = convert(&key[8]);
        vector_[14] = convert(&key[12]);
